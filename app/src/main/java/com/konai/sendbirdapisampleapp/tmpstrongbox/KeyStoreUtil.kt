...
import com.konai.sendbirdapisampleapp.tmpstrongbox.StrongBoxConstants.KEYSTORE_TYPE
...
//Create
    ...
    fun createPublicKeyByECPoint(affineX: BigInteger, affineY: BigInteger): PublicKey {
        ...
        val keyFactory = KeyFactory.getInstance(KEY_GEN_ALGORITHM_EC)
